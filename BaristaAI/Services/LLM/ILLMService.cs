...
namespace BaristaAI.Services.LLM
{
    public interface ILLMService
    {
        ...
        public Task<GenerateTextResponse> GetChatResponse(string message);
        ...
        public Task<GenerateTextResponse> GetTextContentFromPrompt(string prompt);
    }
}
